...
As tecnologias usadas no projeto foram inicialmente o software Visual Studio para que possamos fazer toda a compilação dos códigos de linguagem HTML, posteriormente hospedamos o Backend no Heroku (plataforma em nuvem como um serviço que suporta várias linguagens de programação). Usamos também o bando de dados MongoDB
